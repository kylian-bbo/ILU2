...
public class JFrameReservation extends JFrame {
	...
	public void enableValidationInformation(String date, String time, String numPersons, int numTable) {
		...
		JOptionPane.showMessageDialog( this, "Réservation confirmée le " + date + " à " + time + " pour " + numPersons +" personnes à la table " + numTable + ".", "Confirmation de réservation", JOptionPane.INFORMATION_MESSAGE);
